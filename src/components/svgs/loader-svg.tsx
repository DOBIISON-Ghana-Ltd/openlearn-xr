...
export const LoaderSvg = memo(({ className, ...props }: SvgProps) => {
  return (
    <svg
      id="octo4423"
      viewBox="0 0 512 512"
    ...
    >
      <style>{`
        ...
        #octo4423 #part1 { animation-delay: 0s; }
        #octo4423 #part2 { animation-delay: 0.125s; }
        #octo4423 #part3 { animation-delay: 0.25s; }
        #octo4423 #part4 { animation-delay: 0.375s; }
        #octo4423 #part5 { animation-delay: 0.5s; }
        #octo4423 #part6 { animation-delay: 0.625s; }
        #octo4423 #part7 { animation-delay: 0.75s; }
        #octo4423 #part8 { animation-delay: 0.875s; }
...
export const LogoSvg = LoaderSvg