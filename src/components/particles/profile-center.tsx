...
import { Dialog, DialogPopup, DialogTrigger, DialogClose } from "@/components/ui/dialog";
import { Tooltip, TooltipPopup, TooltipTrigger } from "../ui/tooltip";
import { CrownIcon, SettingsIcon, UserIcon, UsersIcon, LogOut } from "lucide-react";
        ...
        <div className="size-full flex items-stretch">
          <div className="bg-muted/20 w-56 h-full border-r flex flex-col">
            ...
            <div className="py-4 w-full px-2">
              <DialogClose onClick={handleLogout} className="w-full flex items-center gap-3 px-3 py-1.5 text-xs-m font-normal hover:bg-muted rounded-full tracking-wide">
                <LogOut strokeWidth={1.5} className="size-4.5" />
                Logout
              </DialogClose>
            </div>
          </div>
