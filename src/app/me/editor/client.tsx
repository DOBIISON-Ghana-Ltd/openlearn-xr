...
import { BeakerIcon, PlusIcon } from 'lucide-react'
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold">Module Editor</h2>
          <p className="text-sm text-muted-foreground mt-1">Create new interactive science labs or edit existing ones.</p>
        </div>
